...
struct WeatherData {
    ...
    var time: UInt64 {
        return self.data["time"] as? UInt64 ?? 0
    }
    ...
    var moonPhase: CGFloat? {
        return self.data["moonPhase"] as? CGFloat
    }
    ...
    var apparentTemperatureMinTime: UInt64? {
        return self.data["apparentTemperatureMinTime"] as? UInt64
    }
    
    /// The maximum apparent temperature during a given date.
    var apparentTemperatureMax: CGFloat? {
        return self.data["apparentTemperatureMax"] as? CGFloat
    }
    ...
    var apparentTemperatureMaxTime: UInt64? {
        return self.data["apparentTemperatureMaxTime"] as? UInt64
    }
}
